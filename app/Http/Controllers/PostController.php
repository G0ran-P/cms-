...
class PostController extends Controller {
  ...
  /**
   * Sprema sadrzaj u storage.
   * Zahtjev varijable prolazi validaciju kada su zadovoljeni parametri kod trazene vrijednosti.
   * Daje naziv slikama po tranutnom vremenu submita/broj.
   * 
   */
  public function store(Request $request) {
    ...
    // napraviti link za storage u public dijelu, slike su u storage.
